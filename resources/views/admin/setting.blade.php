            ...
            <div class="leading-loose">
                <form action="{{ route('add.subject') }}" method="POST" class="p-10 bg-white rounded shadow-xl">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="si" name="si"
                            rows="6" required="" placeholder="SI">
                    </div>

                    <div class="mt-2">
                        <label class=" block text-sm text-gray-600" for="en">English</label>
                        <input type="text" class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="en" name="en"
                            rows="6" required="" placeholder="EN">
                    </div>
                    <div class="mt-6">
                ...
                <form class="p-10 bg-white rounded shadow-xl">
                    <div class="">
                        ...
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="name" name="name"
                            type="text" required="" placeholder="Grade Name" aria-label="Name">
                    </div>
                    <div class="mt-6">
                        <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded"
                    ...
                    <tbody class="text-gray-700">
                        @forelse ($grades as $grade)
                            <tr>
                                ...
                                <td class="w-1/3 text-left py-3 px-4">{{ $grade->name }}</td>
                            </tr>
                        @empty
