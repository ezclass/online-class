                                    ...
                                    <tr>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 w-10 h-10">
                                                    <img class="w-10 h-10 rounded-full"
                                                        src="{{ Storage::disk('do')->url('avatar/' . $user->avatar) }}"
                                                        alt="" />
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">
                                                {{ $user->created_at->isoFormat('MMM Do Y, h:mm a') }}</p>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                            @if ($user->email_verified_at and $user->phone_number_verified_at)
                                                <p
                                                    class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 bg-gray-100 rounded-full">
                                                    Verified</p>
                                            @else
                                                <p
                                        ...
                                        @if ($user->status == 1)
                                            <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                                <a href="{{ route('deactive.user', $user) }}"
                                                    class="activeuser inline-flex px-2 text-xs font-semibold leading-5 text-green-800 bg-green-100 rounded-full">
                                                    Active
                                                </a>
                                            </td>
                                        @else
                                            <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                                <a href="{{ route('active.user', $user) }}"
                                                    class="deactiveuser inline-flex px-2 text-xs font-semibold leading-5 text-red-800 bg-red-100 rounded-full">
                                                    Deactive
                                                </a>
                                            </td>
                                        @endif
                                        ...
                                        @if (implode(', ', $user->roles->pluck('name')->toArray()) == 'teacher')
                                            <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                                <a href="{{ route('teacher.pay', $user) }}"
                                                    class="text-yellow-500">Show
                                                    More</a>
                                            </td>
                                        @else
                                        ...
                                        @role('super_admin')
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                            <a href="{{ route('edit.user', $user) }}" class="text-yellow-500">Edit
                                                User</a>
                                        </td>
                                        @endrole
