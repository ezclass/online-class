                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">
                                            {{ $user->created_at->isoFormat('MMM Do Y, h:mm a') }}
                                        </p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        ...
                                        @else
                                        <p class="inline-flex px-2 text-xs font-semibold leading-5 text-pink-800 bg-pink-100 rounded-full">
                                            {{ $user->gender }}
                                        </p>
                                        @endif
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        ...
                                        <p class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 bg-gray-100 rounded-full">
                                            Verified</p>
                                        @else
                                        <p class="inline-flex px-2 text-xs font-semibold leading-5 text-yellow-800 bg-yellow-100 rounded-full">
                                            Not verified</p>
                                        @endif
