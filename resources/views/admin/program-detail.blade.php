                                    ...
                                    <tr>
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">
                                                {{ $lesson->created_at->isoFormat('MMM Do Y, h:mm a') }}</p>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">
                                                {{ $lesson->class_date->isoFormat('MMM Do Y, h:mm a') }}</p>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                            <a href="{{ route('meeting.detail', $lesson->getRouteKey()) }}"
                                                class="whitespace-no-wrap text-indigo-500">Show Meeting Detail</a>
                                        </td>
                                        @role('super_admin')
                                        <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                            <a href="{{ route('delete.lesson', $lesson) }}"
                                                class="whitespace-no-wrap text-red-500 deleteclassbtn">Delete lesson</a>
                                        </td>
                                        @endrole
                                    </tr>
                                @empty
