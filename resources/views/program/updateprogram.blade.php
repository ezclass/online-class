    ...
    <x-bg-layout>
        ...
        <form action="{{route('update.program',$program->getRouteKey())}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <textarea  cols="30" rows="5" value="{{ $program->description }}" name="description" id="description" :value="old('description')" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                {{ $program->description }}
                </textarea>
            </div>
