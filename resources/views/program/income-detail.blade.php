<x-app-layout>
    ...
    <div class="bg-yellow-100 border text-center border-yellow-400 text-yellow-700 p-3 rounded relative my-6  shadow" role="alert">
        <span class="block sm:inline">
            Please note that we (Sensemart Education-Business Name) / (homeclass.lk-web) charge 10% for students who register using your reference number and 20% for students who contact us.
         </span>
    </div>
