...
<div class="each mb-10 m-2 shadow-lg border-gray-800 bg-gray-100 relative">
    ...
    <div class="desc p-4 text-gray-800">
        ...
        <h6 class="mt-2 text-sm font-medium">Class Time : <span class="text-indigo-700">{{ $enrolment->program->start_time->format('h:i A')}} To {{ $enrolment->program->end_time->format('h:i A')}}</span></h6>
        ...
        <div class="text-center leading-none flex justify-center absolute bottom-0 left-0 w-full py-2">
            ...
            <span class="text-yellow-400 mr-3 inline-flex items-center leading-none text-md  py-1 border-gray-200">
