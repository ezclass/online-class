<form action="{{route('file.upload',$lesson)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
        <div class="mt-4">
            <label for="title" class="block text-gray-600 dark:text-gray-200 text-sm font-medium mb-2">Title</label>
        ...
        <div class="mt-4">
            <label for="file" class="block text-gray-600 dark:text-gray-200 text-sm font-medium mb-2">File</label>
