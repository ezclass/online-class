<div class="mt-5 mx-auto">
    ...
    <div class="relative  block md:flex items-center " style="min-height: 19rem;">
        ...
        <div class="w-full md:w-3/5 h-full flex items-center ">
            ...
            <svg class="hidden md:block absolute inset-y-0 h-full w-24 fill-current text-blue-100 -ml-12" viewBox="0 0 100 100" preserveAspectRatio="none">
