...
<div>
    ...
    <div class="flex items-center justify-center pt-5 pb-5">
        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
            ...
            <form action="{{route('save.student.account.verify', Auth::user())}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                    <div class="grid grid-cols-1">
                        <label class=" md:text-sm text-xs text-gray-500 text-light font-semibold">Date of Birth (උපන්දිනය)<span class="text-red-500">*</span></label>
                    ...
                    <div class="grid grid-cols-1">
                        <label class=" md:text-sm text-xs text-gray-500 text-light font-semibold">School (ඉගෙනුම ලබන පාසල)<span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class=" md:text-sm text-xs text-gray-500 text-light font-semibold">Select Province (පළාත තෝරන්න) <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class=" md:text-sm text-xs text-gray-500 text-light font-semibold">Select District (දිස්ත්‍රික්කය තෝරන්න) <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class=" md:text-sm text-xs text-gray-500 text-light font-semibold mb-1">Upload a photo of the student (ශිෂ්‍යයාගේ ඡායාරූපයක් උඩුගත කරන්න)<span class="text-red-500">*</span></label>
