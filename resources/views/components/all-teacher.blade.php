                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 w-10 h-10">
                                                <img src="{{ Storage::disk('do')->url('avatar/' . $teacher->avatar) }}"
                                                    alt="avatar"
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">
                                            {{ $teacher->created_at->isoFormat('MMM Do Y, h:mm a') }}</p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        <a href="{{ route('public.dashboard', $teacher) }}"
                                            class="text-indigo-500 whitespace-no-wrap"> Public Dashboard</a>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                        <a href="{{ route('teacher.pay', $teacher) }}" class="text-indigo-500">Show
                                            Details</a>
                                    </td>
                                </tr>
                            @empty
