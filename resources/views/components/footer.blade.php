<footer class=" bg-gradient-to-r from-yellow-500 dark:bg-gray-800">
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid gap-6 grid-cols-2 sm:grid-cols-3 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+94 76-9226409</span>
                        <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">ezclass@email.com</span>
                    </div>
                </div>
            </div>
        </div>
