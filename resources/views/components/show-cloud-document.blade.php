                    ...
                    <table class="min-w-full leading-normal">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                    <input type="text" value="{{$document->cloud}}" id="link" class="text-gray-900 whitespace-no-wrap">

                                </td>
                                <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
                                    <a href="{{$document->cloud}}" target="new" class="text-blue-500"><u>Click Go to Document</u></a>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-300 bg-white text-sm">
