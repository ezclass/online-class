<x-app-layout>
            ...
            <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                <div class="hero-text col-span-6">
                    <div class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">
                        <x-search-class-form :selected-grade-id="$selectedGradeId"
                            :selected-subject-id="$selectedSubjectId" />
                    </div>
                </div>

                <div class="hero-image col-span-6">
                    <svg id="b9c085e1-b209-40d5-b9c5-2decca8817ec" data-name="Layer 1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 1177 494.25" class="w-full max-w-lg lg:max-w-full mx-auto">
                        <defs>
                            <linearGradient id="e1e32c93-0bc3-4bc5-85c6-efac924cbce5" x1="313.79" y1="660.67"
                                x2="313.79" y2="660.43" gradientTransform="matrix(-1, 0, 0, 1, 651, 0)"
                        ...
                        <path
                            ...
                            transform="translate(-11.5 -202.87)" fill="#6c63ff" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-11.5 -202.87)" fill="#3f3d56" />
                        <path d="M309.07,460.54l-5,20.73S300.05,481.24,309.07,460.54Z"
                            transform="translate(-11.5 -202.87)" opacity="0.1" />
                        ...
                        <path
                            ...
                            transform="translate(-11.5 -202.87)" opacity="0.1" />
                        <path d="M275.56,607.71s1.79,8.77,3.24,7.08" transform="translate(-11.5 -202.87)"
                            opacity="0.1" />
                        <path
                            ...
                            stroke-width="4" />
                        <path d="M133.7,540.61a14,14,0,0,0-7-11.5l-3.14,6.21.09-7.52a14,14,0,1,0,10.06,12.81Z"
                            transform="translate(-11.5 -202.87)" fill="#57b894" />
                        <path d="M108.67,635.6a14,14,0,1,1,.68-11.3l-8.77,7.13,9.65-2.23A14,14,0,0,1,108.67,635.6Z"
                            transform="translate(-11.5 -202.87)" fill="#57b894" />
                        <path
    ...
    <div class="holder mx-auto w-11/12 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
