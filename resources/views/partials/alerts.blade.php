    ...
    <div class="flex max-w-sm w-full mx-auto bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        ...
        <div class="-mx-3 py-2 px-4">
            <div class="mx-3">
                ...
                <p class="text-gray-600 dark:text-gray-200 text-sm">{{session('success')}}</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="flex max-w-sm w-full mx-auto bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        ...
        <div class="-mx-3 py-2 px-4">
            <div class="mx-3">
                ...
                <p class="text-gray-600 dark:text-gray-200 text-sm">  {{session('warning')}}</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="flex max-w-sm w-full mx-auto bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        ...
        <div class="-mx-3 py-2 px-4">
            <div class="mx-3">
                ...
                <p class="text-gray-600 dark:text-gray-200 text-sm"> {{session('error')}}</p>
            </div>
        </div>
    </div>
</div>
