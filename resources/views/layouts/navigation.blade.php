<nav x-data="{ open: false }" class="bg-gradient-to-r from-yellow-500 border-b border-gray-200">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                duration-150 ease-in-out">
                                    <div><img src="storage/avatar/{{Auth::user()->avatar}}" alt="avater" class="inline-block h-8 w-8 rounded-full ring-2 ring-white" /></div>
